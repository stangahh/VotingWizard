...
public class ExtendedElection extends PrefElection {
	...
	/*
	 * Example usage follows. Please use in your PrefElectionTests class Either
	 * use this as a separate object to use just for the loadVotes() case, or
	 * alternatively run all your PrefElection methods tests off this object. As
	 * it is a subclass, all such methods will be available.
	 * 
	 * 
	 ...
	 * ElectionException, IOException, NumbersException { elec = new
	 * ExtendedElection("MorgulVale"); elec.loadDefs(); elec.loadVotes(); }
	 * 
	 * @Test public void testLoadVotesMorgulValeThirtyVotes() { VoteCollection
	 * vc = (VoteCollection) elec.getVoteCollection();
	 ...
	 * 
	 * @param name
	 * <code>String</code> Election name
	 */
